...
class MailerController extends Controller
{
    ...
    public function composeEmail($to,$name,$tipo,$url)
    {
        ...
        try
        {
            ...
            $mail->Subject =  $array_setup_email['subject'];
            $mail->Body    =  $array_setup_email['body'];
            $mail->AltBody =  $array_setup_email['altbody'];
    ...
    private function setup_email($email,$name,$tipo,$url)
    {
        ...
        switch($tipo)
        {
            ...
            case 1:
                $array_email =
                [
                    'subject' => 'Did you forget your password for AA Motors APP?',
                    'body'    => $this->tmp_forgotpass($url,$name,$email),
            ...
            case 2:
                ...
                [
                    ...
                    'body'    => $this->tmp_saved_password($url,$name,$email),
                    'altbody' => 'You have to update your browser. Contact with the ADMIN,'
                ];
                break;
            //new user
            case 3:
                    $array_email =
                    [
                        'subject' => 'Welcome to AA Motors APP',
                        'body'    => $this->tmp_new_account($url,$name,$email),
                        'altbody' => 'You have to update your browser. Contact with the ADMIN,'
                    ];
                    break;
    ...
    private function template()
    {
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="font-family:Montserrat, sans-serif">
          <head>
            ...
            <title>Nueva plantilla de correo electrC3B3nico 2022-01-14</title>
            <!--[if (mso 16)]>
            <style type="text/css">
    ...
    private function tmp_forgotpass($url_reset,$name_user,$mail_user)
    {
        $template_forgotpass = '<div class="es-wrapper-color" style="background-color:#F6F6F6">
        <!--[if gte mso 9]>
        ...
        <tr>
        <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;font-size:0px"><a target="_blank" href="#" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#1376C8;font-size:14px"><img src="https://i.ibb.co/BVcSR5j/car-logo.png" alt="Logo" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic; max-width: 120px;" title="Logo"></a></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
        ...
        <tr>
        <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:19px;color:#333333;font-size:16px">Hello {$name_user},<br><br>We have received a request to reset the password for the AA Motors APP account associated with <strong>{$email_user}</strong>. No changes have been made to your account yet.<br><br>You can reset your password by clicking the link below:</p></td>
        </tr>
        <tr>
        <td align="center" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px"><span class="es-button-border" style="border-style:solid;border-color:#2CB543;background:#F4B459;border-width:0px;display:inline-block;border-radius:10px;width:auto"><a href="{$url_reset_password}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#ffffff;font-size:18px;border-style:solid;border-color:#F4B459;border-width:10px 20px 10px 20px;display:inline-block;background:#F4B459;border-radius:10px;font-family:arial, helvetica neue, helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center">RESET YOUR PASSWORD</a></span></td>
        </tr>
        <tr>
        ...
        <tr>
        <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:19px;color:#333333;font-size:16px">Just so you know: You have <strong>30 minutes </strong>to pick your password. After that, you will have to ask for a new one.<br><br>Did not ask for a new password? You can ignore this email.<br><br><strong>AA Motors Team</strong></p></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
        ...
        $template_forgotpass_tmp    = str_replace('{$body_html}',$template_forgotpass,$this->template());
        $template_forgotpass_final   = str_replace(array('{$name_user}','{$email_user}','{$url_reset_password}'),array($name_user,$mail_user,$url_reset),$template_forgotpass_tmp);

        return $template_forgotpass_final;
    }

    private function tmp_new_account($url_create_pass,$name_user,$mail_user)
    {
        $template_new_account = '<div class="es-wrapper-color" style="background-color:#F6F6F6">
        <!--[if gte mso 9]>
        <v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t">
        <v:fill type="tile" color="#f6f6f6"></v:fill>
        </v:background>
        ...
        <tr>
        <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:montserrat, sans-serif;line-height:19px;color:#333333;font-size:16px">Hello <strong>{$name_usr}</strong>,<br><br>A new access to our application has been created with this email: <strong>{$email_usr}</strong>.<br><br>You should create a new password, with the link below you can do it.</p></td>
        </tr>
        <tr>
        <td align="center" class="es-m-p15b" style="Margin:0;padding-top:10px;padding-left:15px;padding-right:15px;padding-bottom:20px"><span class="es-button-border" style="border-style:solid;border-color:#2CB543;background:#F4B459;border-width:0px;display:inline-block;border-radius:10px;width:auto"><a href="{$url_create_pass}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#ffffff;font-size:18px;border-style:solid;border-color:#F4B459;border-width:10px 20px 10px 20px;display:inline-block;background:#F4B459;border-radius:10px;font-family:Montserrat, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center">Create Password</a></span></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
        ...
        $template_new_account_temp    = str_replace('{$body_html}',$template_new_account,$this->template());
        $template_new_account_final   = str_replace(array('{$name_usr}','{$email_usr}','{$url_create_pass}'),array($name_user,$mail_user,$url_create_pass),$template_new_account_temp);

        return $template_new_account_final;
    }


    private function tmp_saved_password($url_login,$name_user,$mail_user)
    {
        $template_saved_password = '<div class="es-wrapper-color" style="background-color:#F6F6F6">
        <!--[if gte mso 9]>
        <v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t">
        <v:fill type="tile" color="#f6f6f6"></v:fill>
        </v:background>
        ...
        <tr>
        <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:19px;color:#333333;font-size:16px">Hello {$name_user},<br><br>We noticed the password for your AA Motors APP account was recently changed. If this was you, you can safely disregard this email.</p></td>
        </tr>
        <tr>
        <td align="center" class="es-m-p15b" style="Margin:0;padding-top:10px;padding-left:15px;padding-right:15px;padding-bottom:20px"><span class="es-button-border" style="border-style:solid;border-color:#2CB543;background:#F4B459;border-width:0px;display:inline-block;border-radius:10px;width:auto"><a href="{$url_login}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#ffffff;font-size:18px;border-style:solid;border-color:#F4B459;border-width:10px 20px 10px 20px;display:inline-block;background:#F4B459;border-radius:10px;font-family:arial, helvetica neue, helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center">Login</a></span></td>
        </tr>
        </table></td>
        </tr>
        </table></td>
        ...
        $template_savepass_tmp    = str_replace('{$body_html}',$template_saved_password,$this->template());
